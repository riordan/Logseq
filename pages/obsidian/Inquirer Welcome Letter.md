...
- Brian Waligorski: Data Architect - Brian was recently hired (Sept) and is tasked with developing the technical architecture (product selection, data flow, etc.) He’s just emerging from learning mode and has been contributing, but job number 1 is to work with him on building out that vision and starting to execute against it.
