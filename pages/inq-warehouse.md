- Bloat
	...
	- There are limitations of the current architecture:
		- DBT Cloud is limited to writing to one GCP project for each [environment](https://cloud.getdbt.com/#/accounts/38962/projects/62160/environments/) it uses. We currently consolidate all of our environments into the `inq-warehouse` project, which combines all of our development, evaluation (PR)
		-
