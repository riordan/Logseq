...
collapsed:: true
	...
	- ### Day Thinking
		...
		- #### Today I should work on
			- Booking [[Metrics Workshop]] Sessions for PMs & Analysts
			- Coding the Metrics Workshop for ads folks
			- Reviewing Brian's analyst productivity call
		- #### Today I would like to work on (but will not) 😭
			- Anything related to the [[Experimentation Platform]]
## Actual Work & Scratch
	- ## [[Newsday]] Homepage Engagement
		- attendees
			- [[matt]]
			- Newsday:
				- emilio guerra - vp digital
				- Anthony Carozzo - director of design and ux
				- tc mccarthy - vp digital development
				- debby krenek - publisher
				- James Steward - dev + accessibility advocate
		- Redesigns & interest in PZN
			- NYT: "In Case You Missed It"
		- History:
			- We've moved away from the right rail on homepage, though ahve it on the story pages
		- Newsday - use of images - they use small images, we use big images and also no images
			- 50/50 split with folks who really like images and folks who really like text
			- having text over image = context for image below
		- Newsday: Have briefs on every headline  | we don't
		- Signed Exchanges: CDN delivered third party scripts
		- PZN:
			- not asking people about interests
			- reading habits + topic modeling
		-
## End-of-Day Wrapup
