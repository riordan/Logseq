...
- ## Day Planning
		...
		- Work Calendar
			...
			- 10:00 - 11:50: Matt and Dave work in person 
			  ...
			  collapse::true
				...
				- DONE Attach notes
				  :LOGBOOK:
				  CLOCK: [2022-06-15 Wed 12:37:48]--[2022-06-26 Sun 16:33:48] =>  267:56:00
				  :END:
	...
	- ### Day Thinking
		...
		- #### Today I would like to work on
			- Watch the [[Ad Map 2.0]] [Testing Plan video](https://drive.google.com/file/d/1nineNuGGEfYbXbeY5KuRiG0sUQV62IzX/view?usp=sharing)
	...
	- ## [[Becky Bowers]]
		...
		- Metric needs
			...
			- "Anything where we're measuring against user experience is a challenge"
				...
				- "Ad sales says x revenue, we say it's kinda bad for users, but MZ or Lisa says "it's fine!" and we do it"
				...
				- Metrtics
					- % PV from search (new audience) vs % of heavy users
						- Had been over-indexing on heavy users
							- Was a key insight from marketing department; might have been Louise Story
...
- ## End-of-Day Wrapup
  collapsed:: true
	...
	- What do you want to do [Tomorrow]([[2022/06/16]])?
		- Review [[Ann Hughes]] [[Last Mile Project]] [business case](https://docs.google.com/spreadsheets/d/1oNc9G6oQhKcsLqmeX4AQkag5TPTu2nzLqiK4cwZz7jo/edit?usp=sharing)
			- >Need some guidance on Investment, Duration, Complexity & Impact - when you have a few mins - thanks!
			-
-
-