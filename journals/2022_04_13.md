	...
	- Meetings Today:
		...
		- EoD Wrapup:
			- NOW Finish [[PMO]] Questions
			  ...
			  :END:
				- Rationalle:
					- Data & Insights is a bridging team for The Philadelphia Inquirer: we work with teams across the whole company to make our operations and activities observable, reportable, then build upon that raw material to make what we're doing
				- Select criteria for:
