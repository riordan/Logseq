			  ...
			  :END:
				...
				- Begin to flesh out the criteria for three classes of projects:
					...
					- Data Activation:
						...
						- Examples:
							- Upcoming:
								- Personalize meter limit to each visitor based on the liklihood that they will subscribe. (Current [[Piano]] project). This requires building a decision-making engine that gets the same data for training the End-to-end pipelines for repeatable training, serving, monitoring of
