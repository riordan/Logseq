			  ...
			  :END:
				...
				- Begin to flesh out the criteria for three classes of projects:
					...
					- Data Activation:
						...
						- Examples:
							- Upcoming:
								- Personalize meter limit to each visitor based on the liklihood that they will subscribe. (Current [[Piano]] project) using a machine learning model End-to-end pipelines for repeatable training, serving, monitoring of
