					...
					- Data Activation:
						...
						- Examples:
							- Upcoming:
								...
								- Collect user demographic data from subscribers and nonsubscribers (via email, website overlays, offline collection, affiliated data partner surveys), then use it to enrigh individual and group demographic profiles
