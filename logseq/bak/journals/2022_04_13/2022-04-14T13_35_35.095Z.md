			...
			- NOW Finish [[PMO]] Questions
			  ...
			  :END:
				...
				- Begin to flesh out the criteria for three classes of projects:
					...
					- Insight  Delivery
						- Doing Doing research and reporting on behalf of the comapny. Primary way team delivers value. Where this is in the course of analysts embedded inside another team's existing project / BAU
					- Data Activation:
