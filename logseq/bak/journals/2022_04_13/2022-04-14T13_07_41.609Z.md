					...
					- Data Activation:
						...
						- Examples:
							- Upcoming:
								...
								- Collect first-party user demographic data from subscribers and nonsubscribers (via email, website overlays, offline collection, affiliated data partner surveys), then use it to enrich individual and group demographic profiles with
