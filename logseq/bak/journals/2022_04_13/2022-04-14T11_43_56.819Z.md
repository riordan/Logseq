			  ...
			  :END:
				...
				- Select criteria for:
					- What qualifies a project for inclusion in a Data PROGRAM with the PMO?
						- Anything that requires the creation of the new piece of infrastructure or new form of analysis that is intended to be reused buy more than one department or project
